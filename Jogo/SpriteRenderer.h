...
public:
	...
	SpriteRenderer(Shader &shader, GLfloat posAnteriorX, GLfloat posX, GLfloat posAnteriorY, GLfloat posY);
	// Destructor
	~SpriteRenderer();
	...
	void DrawTileSet(Texture2D & texture, glm::vec2 position, GLfloat z, glm::vec2 size, GLfloat rotate, glm::vec3 color);
private:
	// Render state
	Shader shader;
	GLuint quadVAO;
