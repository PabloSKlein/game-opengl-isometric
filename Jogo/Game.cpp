...
SpriteRenderer  *RendererTileSet;
...
void Game::Init()
{
	...
	ResourceManager::LoadTexture("textures/smb_tiles.png", GL_TRUE, "TileSet");
	...
	//TileSet
	glm::vec2 TileSetPos = glm::vec2(0, 0);       //  /13 /11
	TileSet = new GameObject(TileSetPos, glm::vec2((220), (186)), ResourceManager::GetTexture("TileSet"));
...
void Game::Render()
{
	if (this->State == GAME_ACTIVE || this->State == GAME_OVER)
	{
		...
		RendererTileSet = new SpriteRenderer(shader1, 0.0f, 4.0f/13.0f, 0.0f, 4.0f / 11.0f);
		...
		TileSet->DrawTileSet(*RendererTileSet, 0.02f);
